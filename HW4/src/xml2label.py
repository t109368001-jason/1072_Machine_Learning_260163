...
ann_path = os.path.abspath(os.path.join(cfg_path, '../../input/train/ann'))
img_path = os.path.abspath(os.path.join(cfg_path, '../../input/train/JPEGImages'))
labels_path = os.path.abspath(os.path.join(cfg_path, '../../input/train/labels'))
train_txt_path = os.path.abspath(os.path.join(cfg_path, 'train.txt'))
data_path = os.path.abspath(os.path.join(cfg_path, 'my.data'))
names_path = os.path.abspath(os.path.join(cfg_path, 'my.names'))
darknet_path = os.path.abspath(os.path.join(cfg_path, '../../darknet/darknet'))

for filename in os.listdir(cfg_path):
    if '.cfg' in filename:
        cfg_txt_path = os.path.abspath(os.path.join(cfg_path, filename))
classes = []
...
os.system('%s detector calc_anchors %s -num_of_clusters %s -width 320 -height 240 -show'%(
        darknet_path, data_path, '6' if 'tiny' in cfg_txt_path else '9'))