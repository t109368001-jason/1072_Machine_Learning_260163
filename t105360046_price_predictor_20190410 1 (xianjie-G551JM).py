...
#remove_columns = ['sale_yr', 'sale_month', 'sale_day', 'zipcode', 'lat', 'long', 'yr_built', 'yr_renovated', 'floors', 'condition', 'waterfront', 'view', 'sqft_basement', 'sqft_lot15', 'bedrooms', 'sqft_lot']
#remove_columns = ['sale_yr', 'sale_month', 'sale_day', 'zipcode', 'yr_built']
remove_columns = ['sale_yr']
...
"""
trainFile['c1'] = trainFile['sqft_living']*trainFile['grade']
validFile['c1'] = validFile['sqft_living']*validFile['grade']
testFile['c1'] = testFile['sqft_living']*testFile['grade']
"""
output = False
force_gpu = False
train_valid = False
...
#optimizer = optimizers.adam(lr=0.001, beta_1=0.9, beta_2=0.999, epsilon=1e-24, decay=1e-4, amsgrad=False)
...
callbacks = []
callbacks.append(keras.callbacks.EarlyStopping(monitor='val_loss', patience=50))
#callbacks.append(RestoreBestWeights(patience=1))
#callbacks.append(EarlyStoppingThreshold(monitor='loss', value=0.15))
#callbacks = None
